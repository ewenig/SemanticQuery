...
SemanticQuery::TextWise::API::Concept - Perl interface for the SemanticQuery (http://www.textwise.com/) Concept API
...
SemanticQuery::TextWise::API::Concept provides native access to the TextWise Concept API.

It is invoked thusly:

    use SemanticQuery::TextWise::API::Concept;;

    my $con = SemanticQuery::TextWise::API::Concept->new(
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc SemanticQuery::TextWise::API::Concept
...
1; # End of SemanticQuery::TextWise::API::Concept
